        ...
        DISCONNECT_STRIPE,
        {
            onCompleted: (data) => {
                if (data && data.disconnectStripe) {
                    ...
                    displaySuccessNotification(
                        "You've successfully disconnect from Strip!",
    ...
    const additionalDetails = user.hasWallet ? (
        <>
            ...
            <Paragraph type="secondary">
                ...
                users from booking listings that you might already created.
            </Paragraph>
        </>
    ) : (
        <>
            <Paragraph>
                Interested in becoming a HotelApp host? Register with your
                Stripe account!
            </Paragraph>
            <Button
